...
```
The wait time at Kestrel Commons between 12:15 and 1:00 is 20 to 25 minutes (dining_kestrel_commons_followup.txt).
```
...
```
The lunch wait at Kestrel Commons between 12:15 and 1:00 is 20 to 25 minutes (dining_kestrel_commons_followup.txt).
```
...
```
Every student gets $30 of printing credit per semester, and it does not roll over [admin_printing_quota.txt].
```
...
```
Every student gets $30 of printing per semester [admin_printing_quota.txt]. It does not roll over [admin_printing_quota.txt].
```
